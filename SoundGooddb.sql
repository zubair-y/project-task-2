...
(
    "id" int NOT NULL REFERENCES "lesson" PRIMARY KEY,
...
(
    "id" int NOT NULL REFERENCES "student" PRIMARY KEY,
...
(
    "person_id" int NOT NULL REFERENCES "contact_details" PRIMARY KEY,
